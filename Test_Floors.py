...
for i in range(17, 18):
    # 模拟点击表格第一行
    realpath = '//*[@id="multiSelect"]/tr[' + str(i) + ']/td[1]'
    ...
    # 模拟点击表格“--”格，显示全部unit
    element5 = driver.find_element('xpath', '//*[@id="multiSelect"]/tr[2]/td[2]')
    # 模拟鼠标移动到元素上并点击
    actions = ActionChains(driver)
    actions.move_to_element(element5).click().perform()
    ...
    # 模拟点击表格“--”格，显示全部unit
    element5 = driver.find_element('xpath', '//*[@id="multiSelect"]/tr[2]/td[3]')
    # 模拟鼠标移动到元素上并点击
    actions = ActionChains(driver)
    actions.move_to_element(element5).click().perform()
    ...
    # 模拟点击表格“--”格，显示全部unit
    element5 = driver.find_element('xpath', '//*[@id="multiSelect"]/tr[2]/td[4]')
    # 模拟鼠标移动到元素上并点击
    actions = ActionChains(driver)
    actions.move_to_element(element5).click().perform()
